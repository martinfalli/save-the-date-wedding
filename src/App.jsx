      ...
      <div className={`rounded-lg shadow-lg text-center w-full mx-auto relative z-10 transition-all duration-500 ease-in-out border ${
        ...
        <div className="flex flex-col items-center justify-center h-full transition-all duration-500 ease-in-out">
          <img 
            src={couplePhoto} 
            alt="Simona & Martin" 
            className={`w-48 h-48 md:w-56 md:h-56 rounded-full object-cover border-4 border-pink-500 shadow-md transition-all duration-200 ease-in-out transform hover:scale-95 active:scale-90 cursor-pointer ${
